...
//  HealthSoftware
//
//  Generated from FHIR 4.5.0-a621ed4bdc (http://hl7.org/fhir/StructureDefinition/BackboneType)
 ...
 */
open class BackboneType: DataType {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? BackboneType else {
			return false
		}
