...
/**
 ...
 URL: http://hl7.org/fhir/CodeSystem/medication-usage-adherence
 ValueSet: http://hl7.org/fhir/ValueSet/medication-usage-adherence
 */
public enum MedicationUsageAdherenceCodes: String, FHIRPrimitiveType {
