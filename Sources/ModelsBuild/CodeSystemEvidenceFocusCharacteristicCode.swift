...
/**
 ...
 URL: http://terminology.hl7.org/CodeSystem/evfocus-characteristic-code
 ValueSet: http://hl7.org/fhir/ValueSet/evfocus-characteristic-code
 */
public enum EvidenceFocusCharacteristicCode: String, FHIRPrimitiveType {
