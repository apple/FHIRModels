...
/**
 ...
 URL: http://terminology.hl7.org/CodeSystem/author-string-source
 ValueSet: http://hl7.org/fhir/ValueSet/author-string-source
 */
public enum AuthorStringSource: String, FHIRPrimitiveType {
