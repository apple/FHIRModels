...
//  HealthSoftware
//
//  Generated from FHIR 6.0.0-ballot3 (http://hl7.org/fhir/StructureDefinition/MedicationDispense)
...
open class MedicationDispense: DomainResource {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		...
		return authorizingPrescription == _other.authorizingPrescription
		    ...
		    && fillNumber == _other.fillNumber
		    && identifier == _other.identifier
		    && location == _other.location
		    && medication == _other.medication
		    && notPerformedReason == _other.notPerformedReason
		    && note == _other.note
	...
	public override func hash(into hasher: inout Hasher) {
		...
		hasher.combine(fillNumber)
		hasher.combine(identifier)
		hasher.combine(location)
		hasher.combine(medication)
		hasher.combine(notPerformedReason)
		hasher.combine(note)
