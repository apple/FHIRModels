...
//  HealthSoftware
//
//  Generated from FHIR 4.6.0-048af26 (http://hl7.org/fhir/StructureDefinition/Transport)
...
open class Transport: DomainResource {
	...
	public var suppliedItem: TransportSuppliedItem?
	...
	public convenience init(
		...
		suppliedItem: TransportSuppliedItem? = nil,
	...
	public required init(from decoder: Decoder) throws {
		...
		self.suppliedItem = try TransportSuppliedItem(from: _container, forKeyIfPresent: .suppliedItem)
 ...
 */
open class TransportSuppliedItem: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TransportSuppliedItem else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
