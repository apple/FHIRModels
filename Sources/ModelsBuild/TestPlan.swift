...
//  HealthSoftware
//
//  Generated from FHIR 6.0.0-ballot2 (http://hl7.org/fhir/StructureDefinition/TestPlan)
...
open class TestPlanTestCase: BackboneElement {
	...
	public var requirement: [TestPlanTestCaseRequirement]?
	...
	public convenience init(
		...
		modifierExtension: [Extension]? = nil,
		requirement: [TestPlanTestCaseRequirement]? = nil,
		scope: [Reference]? = nil,
	...
	public required init(from decoder: Decoder) throws {
		...
		self.requirement = try [TestPlanTestCaseRequirement](from: _container, forKeyIfPresent: .requirement)
		self.scope = try [Reference](from: _container, forKeyIfPresent: .scope)
 ...
 */
open class TestPlanTestCaseRequirement: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestPlanTestCaseRequirement else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
