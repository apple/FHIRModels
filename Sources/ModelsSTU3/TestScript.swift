...
open class TestScriptRule: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptRule else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
		}
		return param == _other.param
		    && resource == _other.resource
	}
...
open class TestScriptRuleParam: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptRuleParam else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
...
open class TestScriptRuleset: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptRuleset else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
...
open class TestScriptRulesetRule: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptRulesetRule else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
...
open class TestScriptRulesetRuleParam: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptRulesetRuleParam else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
...
open class TestScriptSetupActionAssertRule: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptSetupActionAssertRule else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
...
open class TestScriptSetupActionAssertRuleParam: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptSetupActionAssertRuleParam else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
...
open class TestScriptSetupActionAssertRuleset: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptSetupActionAssertRuleset else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
		}
		return rule == _other.rule
		    && rulesetId == _other.rulesetId
	}
	
	public override func hash(into hasher: inout Hasher) {
		super.hash(into: &hasher)
		hasher.combine(rule)
		hasher.combine(rulesetId)
	}
}
...
open class TestScriptSetupActionAssertRulesetRule: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptSetupActionAssertRulesetRule else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
...
open class TestScriptSetupActionAssertRulesetRuleParam: BackboneElement {
	...
	public override func isEqual(to _other: Any?) -> Bool {
		guard let _other = _other as? TestScriptSetupActionAssertRulesetRuleParam else {
			return false
		}
		guard super.isEqual(to: _other) else {
			return false
